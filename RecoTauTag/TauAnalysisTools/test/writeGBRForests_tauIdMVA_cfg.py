    ...
    jobs = cms.VPSet(
        cms.PSet(
            categories = cms.VPSet(
                cms.PSet(
                    inputFileName = cms.string('/data1/veelken/tmp/tauIdMVATraining/tauId_v1_14_1/mvaIsolation3HitsDeltaR05opt2a_BDTG.weights.xml'),                                                           
        ...
        cms.PSet(
            categories = cms.VPSet(
                cms.PSet(
                    inputFileName = cms.string('/data1/veelken/tmp/tauIdMVATraining/tauId_v1_14_1/mvaIsolation3HitsDeltaR05opt2aLT_BDTG.weights.xml'),                                                           
                    inputFileType = cms.string("XML"),
                    inputVariables = cms.vstring(
                        'TMath::Log(TMath::Max(1., recTauPt))',
                        'TMath::Abs(recTauEta)',
        ...
        cms.PSet(
            categories = cms.VPSet(
                cms.PSet(
                    inputFileName = cms.string('/data1/veelken/tmp/tauIdMVATraining/tauId_v1_14_1/mvaIsolation3HitsDeltaR05opt2b_BDTG.weights.xml'),                                                           
                    inputFileType = cms.string("XML"),
                    inputVariables = cms.vstring(
                        'TMath::Log(TMath::Max(1., recTauPt))',
                        'TMath::Abs(recTauEta)',
        ...
        cms.PSet(
            categories = cms.VPSet(
                cms.PSet(                                     
                    inputFileName = cms.string('/data1/veelken/tmp/tauIdMVATraining/tauId_v1_14_1/mvaIsolation3HitsDeltaR05opt2bLT_BDTG.weights.xml'),                                                           
                    inputFileType = cms.string("XML"),
                    inputVariables = cms.vstring(
                        'TMath::Log(TMath::Max(1., recTauPt))',
                        'TMath::Abs(recTauEta)',
